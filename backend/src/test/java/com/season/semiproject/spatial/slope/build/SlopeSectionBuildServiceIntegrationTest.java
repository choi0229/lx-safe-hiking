 ...
 * runs NetworkChainBuilder/ElevationProfile/SlopeSectionCalculator/ChainDistanceLocator and persists
 * the result into `slope_section`.
 *
...
class SlopeSectionBuildServiceIntegrationTest {
     ...
     * confirms the per-Segment geometry cut accuracy survives persistence intact. */
    @Test
    void persistedGeometryLengthCloselyMatchesDeclaredDistance() {
        ...
        // Measured median ~0.18%, p95 ~1.58%, max ~5.34% -- persistence must not make this
        // worse. 10% is a generous ceiling.
    ...
    void readDaoStillExposesTheRawComputationQueriesForBuildUseOnly() {
        ...
        // still reachable through the shared SlopeSectionDAO.
