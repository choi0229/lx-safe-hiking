...
/**
 * Real-database verification of the Production Query path: {@link SlopeSectionService} only
 * reads already-persisted `slope_section` rows -- no NetworkChainBuilder/ElevationProfile/
 * SlopeSectionCalculator call happens on this path. {@link SlopeSectionBuildServiceIntegrationTest}
...
class SlopeSectionServiceIntegrationTest {
    ...
    void absentWindowValueReturnsEmptyNotError() {
        ...
        // compute anything (no runtime fallback).
