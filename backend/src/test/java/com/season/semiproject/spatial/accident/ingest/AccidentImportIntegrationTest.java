package com.season.semiproject.spatial.accident.ingest;
...
/**
 * Real-database verification against the live Docker PostgreSQL/PostGIS instance. Every test
 * method is wrapped in a transaction that Spring's test framework rolls back afterward, so none of
 * these tests leave any permanent change -- whatever accident_point state existed before this
 * class ran (e.g. from a real `spatial-accident-import` run) is restored after each test.
 *
...
class AccidentImportIntegrationTest {
    ...
    void duplicateCoordinateAccidentsAreStoredAsSeparateRows() throws Exception {
        ...
        // Known ground truth for this exact source file: 10 groups of Features
