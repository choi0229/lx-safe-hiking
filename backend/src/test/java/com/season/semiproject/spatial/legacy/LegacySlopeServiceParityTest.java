...
/**
 * Real-data JS <-> Java parity test for the Legacy Slope Compatibility layer.
 *
 ...
 * here -- the compatibility source is intentionally the raw file.
 *
...
class LegacySlopeServiceParityTest {
    ...
    void groupSizeFiveAllCoursesCombinedMatchesPriorLegacyStatistics() {
        // Cross-check against the known analysis figures (1177 total groups,
