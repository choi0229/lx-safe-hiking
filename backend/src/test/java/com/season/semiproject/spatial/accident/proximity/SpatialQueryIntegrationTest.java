...
import com.season.semiproject.spatial.accident.ingest.AccidentImportService;
 ...
 * rebuilt (TrailSegment ids are not permanent).
 *
...
class SpatialQueryIntegrationTest {
    ...
    // The known-nearest pair: report 20231103201R00346 sits ~1.46m
    ...
    void onlyTwoOfFortyTwoAccidentsHaveAnySegmentWithinThirtyMeters() throws Exception {
        // Regression baseline: at 30m, only 2 of 42 real accident points have any TrailSegment
        // nearby at all -- most of this dataset's coordinates are hundreds of meters from the
        // trail network.
        ensureImported();
    ...
    void trailLevelQueryDedupesAnAccidentMatchingManySegmentsIntoOneRowWithMinDistance() throws Exception {
        ...
        // above, but through the Trail-level query: GROUP BY a.id must collapse those
