...
import com.season.semiproject.spatial.trail.ingest.FeatureValidationResult;
 ...
 * confirmed to be entirely valid; a validation failure here means something about the source
 * file changed and must be looked at, not coerced.
 *
