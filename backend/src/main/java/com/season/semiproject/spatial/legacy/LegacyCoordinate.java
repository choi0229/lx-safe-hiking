 ...
 * it is NOT a verified elevation. The legacy JS calls this field "elevation";
 * this type intentionally does not, to avoid restating an unverified physical claim.
 */
