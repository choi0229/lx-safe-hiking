 ...
 * outside {@code [coverageStartMeters, coverageEndMeters]} has no defined elevation --
 * SlopeSections are only ever generated inside the covered range.
 */
public final class ElevationProfile {
    ...
    public static ElevationProfile build(NetworkChain chain) {
        Map<Long, double[]> spanByFeature = new HashMap<>();
    ...
    /**
     * Debug/trace helper only -- lets tests print which two DN samples bracket a given
     * SlopeSection's boundary. Never exposed through the production API/DTOs.
     */
