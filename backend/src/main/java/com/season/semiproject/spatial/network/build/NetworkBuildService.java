package com.season.semiproject.spatial.network.build;
 ...
 *
 * Topology is built using EXACT coordinate equality only. No snapping tolerance is applied (a
 * near-endpoint tolerance experiment was run for reference but intentionally not used), and no
 * mid-line splitting is performed (none of the candidate intersections found in the data turned
 * out to be genuine non-endpoint crossings). Every TrailSegment's geometry is copied unchanged
 * from its source LineString Part.
 *
