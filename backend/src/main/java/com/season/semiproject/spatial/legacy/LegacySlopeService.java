...
/**
 * Legacy Slope Compatibility. Reproduces the legacy frontend's
 ...
 * from, so it does not depend on the frontend directory layout.
 *
 ...
 * included here, exactly as the legacy frontend includes them. This class
 * implements the legacy compatibility source only, and must not be pointed
 * at TrailFeature.
 */
@Service
